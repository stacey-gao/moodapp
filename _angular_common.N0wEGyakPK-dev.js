import { BrowserPlatformLocation, DomAdapter, LOCATION_INITIALIZED, PlatformLocation, XhrFactory, getDOM, parseCookieValue, setRootDomAdapter } from "@nf-internal/chunk-WF4PYHG7";
...
var LocationStrategy = class _LocationStrategy {
    historyGo(relativePosition) {
        throw new Error(true ? "Not implemented" : "");
    }
...
var APP_BASE_HREF = new InjectionToken(true ? "appBaseHref" : "");
...
var NoTrailingSlashPathLocationStrategy = class _NoTrailingSlashPathLocationStrategy extends PathLocationStrategy {
    ...
    static \u0275fac = /* @__PURE__ */ (() => {
        ...
        return function NoTrailingSlashPathLocationStrategy_Factory(__ngFactoryType__) {
            return (\u0275NoTrailingSlashPathLocationStrategy_BaseFactory || (\u0275NoTrailingSlashPathLocationStrategy_BaseFactory = i0.\u0275\u0275getInheritedFactory(_NoTrailingSlashPathLocationStrategy)))(__ngFactoryType__ || _NoTrailingSlashPathLocationStrategy);
        };
    })();
    static \u0275prov = /* @__PURE__ */ i0.\u0275\u0275defineInjectable({
...
(() => {
    i0.\u0275setClassMetadata(NoTrailingSlashPathLocationStrategy, [{
            type: Injectable,
            args: [{
                    providedIn: "root"
                }]
...
var TrailingSlashPathLocationStrategy = class _TrailingSlashPathLocationStrategy extends PathLocationStrategy {
    ...
    static \u0275fac = /* @__PURE__ */ (() => {
        ...
        return function TrailingSlashPathLocationStrategy_Factory(__ngFactoryType__) {
            return (\u0275TrailingSlashPathLocationStrategy_BaseFactory || (\u0275TrailingSlashPathLocationStrategy_BaseFactory = i0.\u0275\u0275getInheritedFactory(_TrailingSlashPathLocationStrategy)))(__ngFactoryType__ || _TrailingSlashPathLocationStrategy);
        };
    })();
    static \u0275prov = /* @__PURE__ */ i0.\u0275\u0275defineInjectable({
...
(() => {
    i0.\u0275setClassMetadata(TrailingSlashPathLocationStrategy, [{
            type: Injectable,
            args: [{
                    providedIn: "root"
                }]
...
import { Optional as Optional2, Inject as Inject2, Injectable as Injectable2, \u0275getLocalePluralCase as _getLocalePluralCase, \u0275getLocaleCurrencyCode as _getLocaleCurrencyCode, \u0275findLocaleData as _findLocaleData, \u0275LocaleDataIndex as _LocaleDataIndex, \u0275RuntimeError as _RuntimeError, \u0275formatRuntimeError as _formatRuntimeError, LOCALE_ID, inject as inject2, \u0275stringify as _stringify, Input, Directive, createNgModule, NgModuleRef, Host, Attribute, RendererStyleFlags2, Injector, isSignal, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as _INTERNAL_APPLICATION_ERROR_HANDLER, \u0275isPromise as _isPromise, \u0275isSubscribable as _isSubscribable, untracked, Pipe, InjectionToken as InjectionToken2, DEFAULT_CURRENCY_CODE, NgModule } from "@angular/core";
...
(() => {
    i02.\u0275setClassMetadata(HashLocationStrategy, [{
            type: Injectable2
        }], () => [{
            type: PlatformLocation
        }, {
...
function checkFullData(data) {
    if (!data[_LocaleDataIndex.ExtraData]) {
        throw new _RuntimeError(2303, `Missing extra locale data for the locale "${data[_LocaleDataIndex.LocaleId]}". Use "registerLocaleData" to load new data. See the "I18n guide" on angular.io to know more.`);
    }
}
...
function getLastDefinedValue(data, index) {
    ...
    throw new _RuntimeError(2304, "Locale data API: locale data undefined");
}
...
function getDatePart(part, date) {
    switch (part) {
        ...
        case 7:
            return date.getDay();
        default:
            throw new _RuntimeError(2301, `Unknown DateType value "${part}".`);
    }
}
...
function getDateTranslation(date, locale, name, width, form, extended) {
    switch (name) {
        ...
        default:
            ...
            throw new _RuntimeError(2302, `unexpected translation type ${unexpected}`);
    }
}
function timeZoneGetter(width) {
    return function (date, locale, offset) {
        ...
        switch (width) {
            ...
            default:
                throw new _RuntimeError(2310, `Unknown zone width "${width}"`);
        }
    };
}
var JANUARY = 0;
...
function toDate(value) {
    ...
    if (!isDate(date)) {
        throw new _RuntimeError(2311, `Unable to convert "${value}" into a date`);
    }
    return date;
}
...
function formatNumberToLocaleString(value, pattern, locale, groupSymbol, decimalSymbol, digitsInfo, isPercent = false) {
    ...
    if (!isFinite(value)) {
        ...
        if (digitsInfo) {
            ...
            if (parts === null) {
                throw new _RuntimeError(2306, `${digitsInfo} is not a valid digit info`);
            }
...
function roundNumber(parsedNumber, minFrac, maxFrac) {
    if (minFrac > maxFrac) {
        throw new _RuntimeError(2307, `The minimum number of digits after fraction (${minFrac}) is higher than the maximum (${maxFrac}).`);
    }
    let digits = parsedNumber.digits;
...
function parseIntAutoRadix(text) {
    ...
    if (isNaN(result)) {
        throw new _RuntimeError(2305, "Invalid integer literal when parsing " + text);
    }
    return result;
}
...
(() => {
    i02.\u0275setClassMetadata(NgLocalization, [{
            type: Injectable2,
            args: [{
                    providedIn: "root",
...
function getPluralCategory(value, cases, ngLocalization, locale) {
    ...
    throw new _RuntimeError(2308, `No plural message found for value "${value}"`);
}
...
(() => {
    i02.\u0275setClassMetadata(NgLocaleLocalization, [{
            type: Injectable2
        }], () => [{
            type: void 0,
            decorators: [{
...
(() => {
    i02.\u0275setClassMetadata(NgComponentOutlet, [{
            type: Directive,
            args: [{
...
var NgIf = class _NgIf {
    ...
    set ngIfThen(templateRef) {
        assertTemplate(templateRef, "ngIfThen");
        this._thenTemplateRef = templateRef;
        this._thenViewRef = null;
        this._updateView();
    }
    set ngIfElse(templateRef) {
        assertTemplate(templateRef, "ngIfElse");
...
function assertTemplate(templateRef, property) {
    if (templateRef && !templateRef.createEmbeddedView) {
        throw new _RuntimeError(2020, `${property} must be a TemplateRef, but received '${_stringify(templateRef)}'.`);
    }
}
...
(() => {
    i02.\u0275setClassMetadata(NgSwitch, [{
            type: Directive,
            args: [{
                    selector: "[ngSwitch]"
                }]
...
(() => {
    i02.\u0275setClassMetadata(NgSwitchCase, [{
            type: Directive,
            args: [{
...
(() => {
    i02.\u0275setClassMetadata(NgSwitchDefault, [{
            type: Directive,
            args: [{
...
(() => {
    i02.\u0275setClassMetadata(NgPlural, [{
            type: Directive,
            args: [{
                    selector: "[ngPlural]"
                }]
...
(() => {
    i02.\u0275setClassMetadata(NgPluralCase, [{
            type: Directive,
            args: [{
...
(() => {
    i02.\u0275setClassMetadata(NgTemplateOutlet, [{
            type: Directive,
            args: [{
...
function invalidPipeArgumentError(type, value) {
    return new _RuntimeError(2100, `InvalidPipeArgument: '${value}' for pipe '${_stringify(type)}'`);
}
...
(() => {
    i02.\u0275setClassMetadata(AsyncPipe, [{
            type: Pipe,
            args: [{
                    name: "async",
                    pure: false
...
(() => {
    i02.\u0275setClassMetadata(LowerCasePipe, [{
            type: Pipe,
            args: [{
                    name: "lowercase"
                }]
...
(() => {
    i02.\u0275setClassMetadata(TitleCasePipe, [{
            type: Pipe,
            args: [{
                    name: "titlecase"
                }]
...
(() => {
    i02.\u0275setClassMetadata(UpperCasePipe, [{
            type: Pipe,
            args: [{
                    name: "uppercase"
                }]
...
var DATE_PIPE_DEFAULT_TIMEZONE = new InjectionToken2(true ? "DATE_PIPE_DEFAULT_TIMEZONE" : "");
var DATE_PIPE_DEFAULT_OPTIONS = new InjectionToken2(true ? "DATE_PIPE_DEFAULT_OPTIONS" : "");
...
(() => {
    i02.\u0275setClassMetadata(DatePipe, [{
            type: Pipe,
            args: [{
                    name: "date"
                }]
...
(() => {
    i02.\u0275setClassMetadata(I18nPluralPipe, [{
            type: Pipe,
            args: [{
                    name: "i18nPlural"
                }]
...
(() => {
    i02.\u0275setClassMetadata(I18nSelectPipe, [{
            type: Pipe,
            args: [{
                    name: "i18nSelect"
                }]
...
(() => {
    i02.\u0275setClassMetadata(JsonPipe, [{
            type: Pipe,
            args: [{
                    name: "json",
                    pure: false
...
var KeyValuePipe = class _KeyValuePipe {
    ...
    transform(input, compareFn = defaultComparator) {
        warnIfSignal("KeyValuePipe", input);
...
(() => {
    i02.\u0275setClassMetadata(KeyValuePipe, [{
            type: Pipe,
            args: [{
                    name: "keyvalue",
                    pure: false
...
(() => {
    i02.\u0275setClassMetadata(DecimalPipe, [{
            type: Pipe,
            args: [{
                    name: "number"
                }]
...
(() => {
    i02.\u0275setClassMetadata(PercentPipe, [{
            type: Pipe,
            args: [{
                    name: "percent"
                }]
...
(() => {
    i02.\u0275setClassMetadata(CurrencyPipe, [{
            type: Pipe,
            args: [{
                    name: "currency"
                }]
...
function strToNumber(value) {
    ...
    if (typeof value !== "number") {
        throw new _RuntimeError(2309, `${value} is not a number`);
    }
    return value;
}
...
(() => {
    i02.\u0275setClassMetadata(SlicePipe, [{
            type: Pipe,
            args: [{
                    name: "slice",
                    pure: false
...
(() => {
    i02.\u0275setClassMetadata(CommonModule, [{
            type: NgModule,
            args: [{
...
import { inject as inject3, DestroyRef, Injectable as Injectable4, \u0275registerLocaleData as _registerLocaleData, Version, \u0275\u0275defineInjectable as __defineInjectable, DOCUMENT as DOCUMENT2, \u0275formatRuntimeError as _formatRuntimeError2, InjectionToken as InjectionToken4, \u0275RuntimeError as _RuntimeError2, \u0275IMAGE_CONFIG as _IMAGE_CONFIG, Renderer2 as Renderer22, ElementRef as ElementRef2, Injector as Injector2, \u0275performanceMarkFeature as _performanceMarkFeature, NgZone, ApplicationRef, booleanAttribute, numberAttribute, ChangeDetectorRef as ChangeDetectorRef2, \u0275IMAGE_CONFIG_DEFAULTS as _IMAGE_CONFIG_DEFAULTS, \u0275unwrapSafeValue as _unwrapSafeValue, Input as Input2, Directive as Directive2 } from "@angular/core";
...
import { InjectionToken as InjectionToken3, Injectable as Injectable3 } from "@angular/core";
var PRECOMMIT_HANDLER_SUPPORTED = new InjectionToken3("", {
    factory: () => {
...
(() => {
    i03.\u0275setClassMetadata(PlatformNavigation, [{
            type: Injectable3,
            args: [{
                    providedIn: "platform",
...
var NavigationAdapterForLocation = class _NavigationAdapterForLocation extends Location {
    navigation = inject3(PlatformNavigation);
    destroyRef = inject3(DestroyRef);
    constructor() {
        super(inject3(LocationStrategy));
...
(() => {
    i04.\u0275setClassMetadata(NavigationAdapterForLocation, [{
            type: Injectable4
        }], () => [], null);
})();
...
var BrowserViewportScroller = class {
    ...
    setHistoryScrollRestoration(scrollRestoration) {
        try {
            ...
            console.warn(_formatRuntimeError2(2400, "Failed to set `window.history.scrollRestoration`. This may occur when:\n\u2022 The script is running inside a sandboxed iframe\n\u2022 The window is partially navigated or inactive\n\u2022 The script is executed in an untrusted or special context (e.g., test runners, browser extensions, or content previews)\nScroll position may not be preserved across navigation."));
        }
    }
...
var IMAGE_LOADER = new InjectionToken4(true ? "ImageLoader" : "", {
...
function throwInvalidPathError(path, exampleUrls) {
    throw new _RuntimeError2(2959, `Image loader has detected an invalid path (\`${path}\`). To fix this, supply a path using one of the following formats: ${exampleUrls.join(" or ")}`);
}
function throwUnexpectedAbsoluteUrlError(path, url) {
    throw new _RuntimeError2(2959, `Image loader has detected a \`<img>\` tag with an invalid \`ngSrc\` attribute: ${url}. This image loader expects \`ngSrc\` to be a relative URL - however the provided value is an absolute URL. To fix this, provide \`ngSrc\` as a path relative to the base URL configured for this loader (\`${path}\`).`);
}
...
var provideCloudflareLoader = createImageLoader(createCloudflareUrl, true ? ["https://<ZONE>/cdn-cgi/image/<OPTIONS>/<SOURCE-IMAGE>"] : void 0);
...
var provideCloudinaryLoader = createImageLoader(createCloudinaryUrl, true ? ["https://res.cloudinary.com/mysite", "https://mysite.cloudinary.com", "https://subdomain.mysite.com"] : void 0);
...
var provideImageKitLoader = createImageLoader(createImagekitUrl, true ? ["https://ik.imagekit.io/mysite", "https://subdomain.mysite.com"] : void 0);
...
var provideImgixLoader = createImageLoader(createImgixUrl, true ? ["https://somepath.imgix.net/"] : void 0);
...
function provideNetlifyLoader(path) {
    if (path && !isValidPath(path)) {
        throw new _RuntimeError2(2959, `Image loader has detected an invalid path (\`${path}\`). To fix this, supply either the full URL to the Netlify site, or leave it empty to use the current site.`);
    }
    if (path) {
        const url = new URL(path);
        path = url.origin;
...
(() => {
    i04.\u0275setClassMetadata(LCPImageObserver, [{
            type: Injectable4,
            args: [{
                    providedIn: "root"
                }]
...
var PRECONNECT_CHECK_BLOCKLIST = new InjectionToken4(true ? "PRECONNECT_CHECK_BLOCKLIST" : "");
...
(() => {
    i04.\u0275setClassMetadata(PreconnectLinkChecker, [{
            type: Injectable4,
            args: [{
                    providedIn: "root"
                }]
...
var PRELOADED_IMAGES = new InjectionToken4(true ? "NG_OPTIMIZED_PRELOADED_IMAGES" : "", {
...
var PreloadLinkCreator = class _PreloadLinkCreator {
    ...
    createPreloadLinkTag(renderer, src, srcset, sizes) {
        if (!this.errorShown && this.preloadedImages.size >= DEFAULT_PRELOADED_IMAGES_LIMIT) {
...
(() => {
    i04.\u0275setClassMetadata(PreloadLinkCreator, [{
            type: Injectable4,
            args: [{
                    providedIn: "root"
                }]
...
var NgOptimizedImage = class _NgOptimizedImage {
    ...
    ngOnChanges(changes) {
        ...
        if (changes["placeholder"]?.currentValue && typeof ngServerMode !== "undefined" && !ngServerMode) {
...
(() => {
    i04.\u0275setClassMetadata(NgOptimizedImage, [{
            type: Directive2,
            args: [{
                    selector: "img[ngSrc]",
                    host: {
...
@angular/common/fesm2022/common.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_common.N0wEGyakPK-dev.js.map
