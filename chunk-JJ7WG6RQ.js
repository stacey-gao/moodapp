...
function producerAccessed(node) {
    if (inNotificationPhase) {
        throw new Error(true ? `Assertion error: signal read during notification phase` : "");
    }
    ...
    return __spreadProps(__spreadValues({}, REACTIVE_NODE), {
        ...
        producerRecomputeValue(node) {
            if (node.value === COMPUTING) {
                throw new Error(true ? "Detected cycle in computations." : "");
            }
...
@angular/core/fesm2022/_weak_ref-chunk.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JJ7WG6RQ.js.map
